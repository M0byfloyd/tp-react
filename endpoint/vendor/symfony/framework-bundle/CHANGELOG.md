 ...
 * Deprecated `FormPass`, use `Symfony\Component\FormLogin\DependencyInjection\FormPass` instead
 ...
 * moved the translation files to the FormLogin and Validator components
